...
def get_longest_caller(input_set):
    phonenumber = max(input_set, key = lambda n: input_set[n])
    time = input_set[phonenumber]
...
print(number +" spent the longest time, " + str(time) +" seconds, on the phone during September 2016.")
