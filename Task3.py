...
recievers_bangalore = get_recivers_from_caller('(080)')
unique_recievers = sorted(set(recievers_bangalore))
...
bangalore_recievers_count = get_calls_to_bangalore_count(recievers_bangalore)
total_calls = len(recievers_bangalore)
